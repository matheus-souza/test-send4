            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/messages/' . $message->id . '/edit') }}" title="Edit message"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Contact Id </th><td> {{ $message->contact_id }} - {{ $message->contact->nome . ' ' . $message->contact->sobrenome }} </td></tr><tr><th> Descricao </th><td> {{ $message->descricao }} </td></tr>
                                </tbody>
                            </table>
                        </div>
